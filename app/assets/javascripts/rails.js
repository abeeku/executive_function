 ...
 *
 * Requires jQu.bind(ery 1.4.3 or later.
 ...
 *
 * Ex:
 *     $('form').bind('ajax:aborted:file', function(){
...
(function($) {
	...
	$('a[data-confirm], a[data-method], a[data-remote]').bind('click.rails', function(e) {
		var link = $(this);
	...
	$('form input[type=submit], form input[type=image], form button[type=submit], form button:not([type])').bind('click.rails', function() {
		var button = $(this);
	...
	$('form').bind('ajax:beforeSend.rails', function(event) {
		if (this == event.target) disableFormElements($(this));
	});

	$('form').bind('ajax:complete.rails', function(event) {
